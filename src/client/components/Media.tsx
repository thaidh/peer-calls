...
const { network, callId, userId } = config;
...
export class MediaForm extends React.PureComponent<
  MediaProps,
  MediaComponentState
> {
  ...
  render() {
    ...
    props.onSetVideoConstraint(props.video);
    props.onSetAudioConstraint(props.audio);
